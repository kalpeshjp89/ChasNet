...
# configurations
img_folder = '/media/dl/DL/Other/dataset/DF2K_sub_image_HR/'  # glob matching pattern
lmdb_save_path = '/media/dl/DL/Other/dataset/DF2K_sub_image_HR.lmdb'  # must end with .lmdb
